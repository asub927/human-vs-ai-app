            ...
            <div className={styles.container}>
                <div className={styles.header}>
                    ...
                    <div className={styles.headerActions}>
                        ...
                        <button className={styles.createButton} onClick={() => setIsCreating(!isCreating)}>
                        ...
                        <tbody>
                            {projects.length === 0 ? (
                                ...
                                projects.map((project) => (
                                    <tr key={project.id} className={`${styles.tr} ${expandedProjectId === project.id ? styles.trExpanded : ''}`}>
                                        ...
                                        <td className={styles.td}>
                                            <div className={styles.actions}>
                                                <button className={styles.manageButton} onClick={() => toggleExpand(project.id)}>
                                            ...
                                            <td colSpan={3} className={styles.expandedCell}>
                                                <div className={styles.tasksContainer}>
                                                    ...
                                                    <form onSubmit={(e) => handleAddTask(e, project.id)} className={styles.addTaskForm}>
                                                        ...
                                                        />
                                                        <button type="submit" className={styles.addTaskButton} disabled={!newTaskNames[project.id]?.trim()}>
                                                            Add Task
                                                        </button>
                                                    </form>
                                                </div>
